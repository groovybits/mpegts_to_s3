...
const config = {
  ...
  CAPTURE_BUFFER_SIZE:env.CAPTURE_BUFFER_SIZE || `4193904`,
  SEGMENT_DURATION_MS: env.SEGMENT_DURATION_MS || `2000`,
  URL_SIGNING_SECONDS: env.URL_SIGNING_SECONDS || `604800`,
  USE_ESTIMATED_DURATION: env.USE_ESTIMATED_DURATION || `true`,
  MAX_SEGMENT_SIZE_BYTES: env.MAX_SEGMENT_SIZE_BYTES || `5242756`,
};
